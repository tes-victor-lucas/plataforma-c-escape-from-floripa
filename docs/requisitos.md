...
- **RN01:** Uma nova partida deve iniciar com o personagem usando seus ataques básicos, sem melhorias ativas.
- **RN02:** Durante o combate, o jogador controla a movimentação do personagem, enquanto os ataques são executados automaticamente conforme a arma ou habilidade disponível.
- **RN03:** Uma sala só pode ser considerada concluída quando todos os inimigos ativos nela forem derrotados.
- **RN04:** Após concluir uma sala, o jogador deve receber exatamente três cartas de melhoria e selecionar uma delas antes de seguir para a próxima sala.
